		...
		<table class="table">
		  ...
		  <?php
						...
						$display = "SELECT complaints.client_id,customer.fname,customer.lname,complaints.issue,property.name,complaints.c_id,complaints.incharge from complaints 
							...
							where complaints.`status` = 'incomplete';";
		  ...
		  <tbody>
		    <tr>
		      ...
		      <td><button type="button" name = "view"class="btn btn-dark"><a href="AViewComplaint.php?action=view&c_id=<?php echo $row['c_id']?>&e_id=<?php echo $row['incharge']?>" style="color:white;">VIEW</a></button></td>
		    </tr>
		    		<?php
