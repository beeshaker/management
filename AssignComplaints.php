		...
		<table class="table">
		  ...
		  <tbody>
		    <tr>
		      ...
		      <td><button type="button" name = "view"class="btn btn-dark"><a href="AssignComplaint.php?action=update&c_id=<?php echo $row['c_id']?>&client_id=<?php echo $row['client_id']?>" style="color:white;">ASSIGN</a></button></td>
		    </tr>
		    		<?php
