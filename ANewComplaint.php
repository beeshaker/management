...
if($_SERVER['REQUEST_METHOD']==='POST')
{
	...
	//	echo $client,$property,$dateofentry,$issue,$desc,$cnum,$ctype,$priority,$status,$type,$assign,$authorize;  
...
<body>
	...
	<div style="padding-top: 5%; padding-bottom: 2%; padding-right: 10%; padding-left: 40%">
		...
		<div class="row">
		    <div class="col-md-6">
		      <form action="ANewComplaint.php" method="POST" enctype="multipart/form-data">
