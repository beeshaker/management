...
<div style="padding-top: 3%; padding-bottom: 2%; padding-right: 5%; padding-left: 5%">
	...
	<div style="padding-top: 5%; padding-bottom: 2%; padding-right: 10%; padding-left: 28%">
		<h1>Update All Complaints</h1>
	</div>
	<div>
		<table class="table">
		  ...
		  <tbody>
		    <tr>
		      ...
		      <td><button type="button" name = "view"class="btn btn-dark"><a href="AUpdateComplaint.php?action=update&c_id=<?php echo $row['c_id']?>&e_id=<?php echo $row['incharge']?>" style="color:white;">UPDATE</a></button></td>
		    </tr>
		    		<?php
