...
<div style="padding-top: 3%; padding-bottom: 2%; padding-right: 5%; padding-left: 5%">
	...
	<div class="container">
		<div class="row">
		    <div class="col-md-4">
		      	<form action="AProperty.php" method="POST">
		...
		<table class="table">
		  ...
		  <?php
						...
						if($_SERVER['REQUEST_METHOD']==='POST')
						{
							...
							$display = "SELECT * from property where property.name like '%$search%';";
		  ...
		  <tbody>
		    <tr>
		      ...
		      <td><button type="button" name = "view"class="btn btn-dark"><a href="AViewProperty.php?action=view&p_id=<?php echo $row['p_id']?>" style="color:white;">VIEW</a></button></td>
		    </tr>
		    		<?php
