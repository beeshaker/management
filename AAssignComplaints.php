...
<div style="padding-top: 3%; padding-bottom: 2%; padding-right: 5%; padding-left: 5%">
		...
		<table class="table">
		  ...
		  <?php
						...
						$display = "SELECT complaints.client_id,customer.fname,customer.lname,complaints.issue,property.name,complaints.c_id,complaints.incharge,complaints.`type` from complaints 
							inner join property on complaints.p_id = property.p_id
							inner join customer on complaints.client_id = customer.u_id
							where complaints.`type` = '0';";
		  ...
		  <tbody>
		    <tr>
		      ...
		      <td><button type="button" name = "view"class="btn btn-dark"><a href="AAssignComplaint.php?action=close&c_id=<?php echo $row['c_id']?>&client_id=<?php echo $row['client_id']?>" style="color:white;">ASSIGN</a></button></td>
		    </tr>
		    		<?php
