		...
		<table class="table">
		  ...
		  <tbody>
		    <tr>
		      ...
		      <td><button type="button" name = "view"class="btn btn-dark"><a href="UpdateComplaint.php?action=update&c_id=<?php echo $row['c_id']?>&e_id=<?php echo $row['incharge']?>" style="color:white;">UPDATE</a></button></td>
		    </tr>
		    		<?php
