			...
			<div class="col-md-3">
				...
				<ul style="padding-top: 2%; padding-bottom: 2%; padding-right: 0%; padding-left: 0%;list-style-type: none;">
      			...
      			<li style="padding-top: 2%; padding-bottom: 2%;">
      				<button type="button" class="btn btn-dark btn-block"><a href="Announcements.php?action=view&p_id=<?php echo $row['p_id']?>" style="color:white;">Post Announcements</a></button>
      			</li>
      			<li style="padding-top: 2%; padding-bottom: 2%;">
      				<button type="button" class="btn btn-dark btn-block"><a href="PViewAllComplaints.php?action=view&p_id=<?php echo $row['p_id']?>" style="color:white;">View Complaints</a></button>
      			</li>
      			<li style="padding-top: 2%; padding-bottom: 2%;">
