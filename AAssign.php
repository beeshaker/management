  ...
  if($conn->query($updatequery) === true)
	{
		   ...
		   //email configuration start---------------------------------------------------------------------
				...
				$email_subject = "Update on the complaint";
				$email_body = "Your complaint  has been assigned to $fname. Employee Email: $employeemail and Phone Number: $phone .\n\n\n
			...
			//email configuration start---------------------------------------------------------------------
				$email_from1 = 'noreply@apricot.ke';//<== update the email address
