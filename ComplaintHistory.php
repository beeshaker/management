		...
		<table class="table">
		  ...
		  <?php
						...
						$display = "SELECT complaints.client_id,customer.fname,customer.lname,complaints.issue,property.name,complaints.c_id,complaints.incharge from complaints 
							...
							where complaints.client_id = (select u_id from customer where email = '$incharge')
		  ...
		  <tbody>
		    <tr>
		      ...
		      <td><button type="button" name = "view"class="btn btn-dark"><a href="ComplaintHistoryDetails.php?action=view&c_id=<?php echo $row['c_id']?>&client_id=<?php echo $row['client_id']?>" style="color:white;">VIEW</a></button></td>
		    </tr>
		    		<?php
