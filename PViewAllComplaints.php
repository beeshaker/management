    ...
    ?>
		  <tbody>
		    <tr>
		      ...
		      <td><button type="button" name = "view"class="btn btn-dark"><a href="PViewComplaint.php?action=view&p_id=<?php echo $row['p_id']?>&c_id=<?php echo $row['c_id']?>" style="color:white;">VIEW</a></button></td>
		    </tr>
		    		<?php
